...
namespace Duongld\Heimdal\Provider;

use Illuminate\Support\ServiceProvider as BaseProvider;
use Duongld\Heimdal\Reporters\BugsnagReporter;
use Duongld\Heimdal\Reporters\RollbarReporter;
use Duongld\Heimdal\Reporters\SentryReporter;
